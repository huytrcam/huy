...
class __TwigTemplate_63c0c4441e0b3cac6b4373604ef80ddef57c88c69d67ccbbde016d51363c6ea5 extends Twig_Template
{
    ...
    public function block_gantry($context, array $blocks = array())
    {
        ...
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('GantryTwig')->transFilter("GANTRY5_PLATFORM_SAVE_PARTICLE_DEFAULTS"), "html", null, true);
        echo "</span></button>
                </span>
                ";
        // line 12
        ...
        foreach ($context['_seq'] as $context["group"] => $context["list"]) {
            if (($context["group"] != "hidden")) {
                ...
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('GantryTwig')->transFilter("GANTRY5_PLATFORM_DEFAULTS"), "html", null, true);
                echo "</span>
                    </h2>
                ...
                foreach ($context['_seq'] as $context["id"] => $context["particle"]) {
                    ...
                    if ( !$this->getAttribute($context["particle"], "hidden", array())) {
                        ...
                        if ($this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", array()), "fields", array()), "enabled", array())) {
                            // line 43
                            echo "                                            ";
                            $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/settings/settings.html.twig", 43)->display(array_merge($context, array("default" => true, "scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "field" => $this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", array()), "fields", array()), "enabled", array()), "value" => $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "config", array()), "get", array(0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled")), "method"))));
                            // line 44
                            echo "
                                            ";
                            // line 45
                        ...
                        echo "                                    </h4>
                                    ...
                                    <div class=\"inner-params\">
                                        ";
                        // line 52
                        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/settings/settings.html.twig", 52)->display(array_merge($context, array("ignore_not_overrideable" => true, "overrideable" => (isset($context["overrideable"]) ? $context["overrideable"] : null), "blueprints" => $this->getAttribute($context["particle"], "form", array()), "skip" => array(0 => "enabled"), "data" => $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "config", array()), "prefix" => (isset($context["prefix"]) ? $context["prefix"] : null))));
                        // line 53
                        echo "                                    </div>
                                </div>
                            ";
...
";
    ...
    {
        return array (  226 => 63,  222 => 62,  217 => 59,  206 => 57,  192 => 56,  187 => 53,  185 => 52,  180 => 49,  177 => 48,  174 => 47,  171 => 46,  169 => 45,  166 => 44,  163 => 43,  161 => 42,  157 => 41,  151 => 40,  146 => 38,  142 => 37,  138 => 36,  134 => 35,  129 => 34,  126 => 33,  123 => 32,  120 => 31,  117 => 30,  100 => 29,  92 => 24,  88 => 23,  76 => 20,  65 => 14,  62 => 13,  51 => 12,  46 => 10,  42 => 9,  37 => 7,  33 => 5,  30 => 4,  27 => 3,  18 => 1,);
    }
}
...
/*                 <span class="float-right">*/
/*                     <button type="submit" class="button button-primary button-save" data-save="{{ 'GANTRY5_PLATFORM_PARTICLE_DEFAULTS'|trans }}">*/
/*                     <i class="fa fa-fw fa-check"></i> <span>{{ 'GANTRY5_PLATFORM_SAVE_PARTICLE_DEFAULTS'|trans }}</span></button>*/
/*                 </span>*/
